...
//            }
            ...
            pst = con.prepareStatement("UPDATE clientinformation SET Contact_No=?, Client_Status=? WHERE Client_Code=?");
            pst.setString(1, contact_no);
            pst.setString(2, client_status);
            pst.setString(3, client_code);
