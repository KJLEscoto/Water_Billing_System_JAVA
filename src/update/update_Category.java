...
public class update_Category extends javax.swing.JFrame {
    ...
    public void updatingCategory() {
        try {
            ...
            // Check for duplicate category type and status
            String queryCheckDuplicate = "SELECT COUNT(*) FROM categories WHERE Category_Type=? AND Status=?";
            ...
            if (duplicateCount > 0) {
                JOptionPane.showMessageDialog(null, "Duplicate Category Type and Status!");
                return; // Exit the method if duplicate category type and status found
            }
